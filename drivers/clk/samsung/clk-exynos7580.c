...
PNAME(mout_bus_pll_apl_user_p) = {"bus_pll", "mout_bus_pll_apl_user"}; // USERMUX

static const unsigned long apl_clk_regs[] __initconst = {
};

static const struct samsung_mux_clock apl_mux_clks[] __initconst = {
	MUX(0, "mout_bus_pll_apl_user", mout_bus_pll_apl_user_p, MUX_SEL_APL_1, 0, 1),
...
static const struct samsung_pll_clock apl_pll_clks[] __initconst = {
	PLL(pll_2555x, CLK_APL_PLL, "apl_pll", "oscclk", APL_PLL_LOCK, APL_PLL_CON0, table_apl),
};
...
PNAME(mout_aud_pll_user_p) = {"aud_pll", "mout_aud_pll_user"}; // USERMUX
...
static const struct samsung_mux_clock aud_mux_clks[] __initconst = {
	MUX(CLK_MOUT_AUD_PLL_USER, "mout_aud_pll_user", mout_aud_pll_user_p, MUX_SEL_AUD0, 0, 1),
...
PNAME(mout_bus_pll_cpu_user_p) = {"bus_pll", "mout_bus_pll_cpu_user"}; //USERMUX

static const unsigned long cpu_clk_regs[] __initconst = {
};

static const struct samsung_mux_clock cpu_mux_clks[] __initconst = {
	MUX(0, "mout_bus_pll_cpu_user", mout_bus_pll_cpu_user_p, MUX_SEL_CPU_1, 0, 1),
...
PNAME(mout_aclk_disp_200_user_p) = {"aclk_disp_200", "mout_aclk_disp_200_user"}; // USERMUX
PNAME(mout_sclk_decon_int_eclk_user_p) = {"sclk_disp_decon_int_eclk", "mout_sclk_decon_int_eclk_user"}; // USERMUX
PNAME(mout_sclk_decon_int_vclk_user_p) = {"sclk_disp_decon_int_vclk", "mout_sclk_decon_int_vclk_user"}; // USERMUX
PNAME(mout_phyclk_bitclkdiv8_user_p) = {"phyclk_txbyteclkhs_m4s4", "mout_phyclk_bitclkdiv8_user"}; // USERMUX
PNAME(mout_phyclk_rxclkesc0_user_p) = {"phyclk_rxclkesc0_m4s4", "mout_phyclk_rxclkesc0_user"}; // USERMUX
...
static const struct samsung_mux_clock disp_mux_clks[] __initconst = {
	MUX(CLK_MUX_ACLK_DISP_200_USER, "mout_aclk_disp_200_user", mout_aclk_disp_200_user_p, MUX_SEL_DISP1, 0, 1),
	MUX(CLK_MUX_SCLK_DECON_INT_ECLK_USER, "mout_sclk_decon_int_eclk_user", mout_sclk_decon_int_eclk_user_p, MUX_SEL_DISP1, 8, 1),
	MUX(CLK_MUX_SCLK_DECON_INT_VCLK_USER, "mout_sclk_decon_int_vclk_user", mout_sclk_decon_int_vclk_user_p, MUX_SEL_DISP1, 12, 1),
	MUX(CLK_MUX_PHYCLK_BITCLKDIV8_USER, "mout_phyclk_bitclkdiv8_user", mout_phyclk_bitclkdiv8_user_p, MUX_SEL_DISP2, 16, 1),
	MUX(CLK_MUX_PHYCLK_RXCLKESC0_USER, "mout_phyclk_rxclkesc0_user", mout_phyclk_rxclkesc0_user_p, MUX_SEL_DISP2, 20, 1),
...
static const struct samsung_pll_clock disp_pll_clks[] __initconst = {
	PLL(pll_2551x, CLK_DISP_PLL, "disp_pll", "oscclk", DISP_PLL_LOCK, DISP_PLL_CON0, table_disp),
};
...
PNAME(mout_phyclk_usbhost20_freeclk_user_p) = {"phyclk_usbhost20_freeclk", "mout_phyclk_usbhost20_freeclk_user"}; // USERMUX
PNAME(mout_phyclk_usbhost20_phyclock_user_p) = {"phyclk_usbhost20_phyclock", "mout_phyclk_usbhost20_phyclock_user"}; // USERMUX
PNAME(mout_phyclk_usbhost20_clk48mohcl_user_p) = {"phyclk_usbhost20_clk48mohcl", "mout_phyclk_usbhost20_clk48mohcl_user"}; // USERMUX
PNAME(mout_phyclk_usbotg20_p) = {"phyclk_usbotg20", "mout_phyclk_usbotg20"}; // USERMUX
...
static const struct samsung_mux_clock fsys_mux_clks[] __initconst = {
	MUX(CLK_FREECLK, "mout_phyclk_usbhost20_freeclk_user", mout_phyclk_usbhost20_freeclk_user_p,  MUX_SEL_FSYS1, 8, 1),
	MUX(CLK_PHYCLK, "mout_phyclk_usbhost20_phyclock_user", mout_phyclk_usbhost20_phyclock_user_p, MUX_SEL_FSYS1, 12, 1),
	MUX(CLK_CLK48MOHCI, "mout_phyclk_usbhost20_clk48mohcl_user", mout_phyclk_usbhost20_clk48mohcl_user_p, MUX_SEL_FSYS1, 16, 1),
	MUX(CLK_PHY_OTG, "mout_phyclk_usbotg20", mout_phyclk_usbotg20_p, MUX_SEL_FSYS2, 12, 1),
};
...
static const struct samsung_pll_clock g3d_pll_clks[] __initconst = {
	PLL(pll_2551x, CLK_G3D_PLL, "g3d_pll", "oscclk", G3D_PLL_LOCK, G3D_PLL_CON0, table_g3d),
};
...
PNAME(mout_aclk_isp_400_user_p) = {"aclk_isp_400", "mout_aclk_isp_400_user"}; // USERMUX
PNAME(mout_aclk_isp_333_user_p) = {"aclk_isp_333", "mout_aclk_isp_333_user"}; // USERMUX
PNAME(mout_aclk_isp_266_user_p) = {"aclk_isp_266", "mout_aclk_isp_266_user"}; // USERMUX
PNAME(mout_sclk_spi0_isp_ext_clk_user_p) = {"sclk_isp_spi0_ext_clk", "mout_sclk_spi0_isp_ext_clk_user"}; // USERMUX
PNAME(mout_sclk_spi1_isp_ext_clk_user_p) = {"sclk_isp_spi1_ext_clk", "mout_sclk_spi1_isp_ext_clk_user"}; // USERMUX
PNAME(mout_sclk_uart_isp_ext_clk_user_p) = {"sclk_isp_uart_ext_clk", "mout_sclk_uart_isp_ext_clk_user"}; // USERMUX
PNAME(mout_phyclk_csi_link0_rx_user_p) = {"phyclk_csi_phy0_rxbyteclkhs0", "mout_phyclk_csi_link0_rx_user"}; // USERMUX
PNAME(mout_phyclk_csi_link1_rx_user_p) = {"phyclk_csi_phy1_rxbyteclkhs0", "mout_phyclk_csi_link1_rx_user"}; // USERMUX
...
static const struct samsung_mux_clock isp_mux_clks[] __initconst = {
	...
	MUX(CLK_MOUT_ACLK_ISP_400_USER, "mout_aclk_isp_400_user", mout_aclk_isp_400_user_p, MUX_SEL_ISP1, 0, 1),
	MUX(CLK_MOUT_ACLK_ISP_333_USER, "mout_aclk_isp_333_user", mout_aclk_isp_333_user_p, MUX_SEL_ISP1, 4, 1),
	MUX(CLK_MOUT_ACLK_ISP_266_USER, "mout_aclk_isp_266_user", mout_aclk_isp_266_user_p, MUX_SEL_ISP1, 8, 1),
	MUX(CLK_MOUT_SCLK_SPI0_ISP_EXT_CLK_USER, "mout_sclk_spi0_isp_ext_clk_user", mout_sclk_spi0_isp_ext_clk_user_p, MUX_SEL_ISP1, 12, 1),
	MUX(CLK_MOUT_SCLK_SPI1_ISP_EXT_CLK_USER, "mout_sclk_spi1_isp_ext_clk_user", mout_sclk_spi1_isp_ext_clk_user_p, MUX_SEL_ISP1, 16, 1),
	MUX(CLK_MOUT_SCLK_UART_ISP_EXT_CLK_USER, "mout_sclk_uart_isp_ext_clk_user", mout_sclk_uart_isp_ext_clk_user_p, MUX_SEL_ISP1, 20, 1),
	MUX(CLK_MOUT_PHYCLK_CSI_LINK0_RX_USER, "mout_phyclk_csi_link0_rx_user", mout_phyclk_csi_link0_rx_user_p, MUX_SEL_ISP2, 0, 1),
	MUX(CLK_MOUT_PHYCLK_CSI_LINK1_RX_USER, "mout_phyclk_csi_link1_rx_user", mout_phyclk_csi_link1_rx_user_p, MUX_SEL_ISP2, 4, 1),
};
...
static const struct samsung_pll_clock isp_pll_clks[] __initconst = {
	PLL(pll_2551x, CLK_ISP_PLL, "isp_pll", "oscclk", ISP_PLL_LOCK, ISP_PLL_CON0, table_isp),
};
...
PNAME(mout_aclk_mscl_400_user_p) = {"aclk_mfcmscl_400", "mout_aclk_mscl_400_user"}; // USERMUX
PNAME(mout_aclk_mfc_266_user_p) = {"aclk_mfcmscl_266", "mout_aclk_mfc_266_user"}; // USERMUX
...
static const struct samsung_mux_clock  mfcmscl_mux_clks[] __initconst = {
	MUX(CLK_MOUT_ACLK_MSCL_400_USER, "mout_aclk_mscl_400_user", mout_aclk_mscl_400_user_p, MUX_SEL_MFCMSCL, 4, 1),
	MUX(CLK_MOUT_ACLK_MFC_266_USER, "mout_aclk_mfc_266_user", mout_aclk_mfc_266_user_p, MUX_SEL_MFCMSCL, 0, 1),
};
...
PNAME(mout_sclk_disp_decon_int_eclk_a_p) = {"oscclk", "bus_pll"};
PNAME(mout_sclk_disp_decon_int_eclk_b_p) = {"mout_sclk_disp_decon_int_eclk_a",
					    "mout_media_pll_div2"};
PNAME(mout_sclk_disp_decon_int_vclk_a_p) = {"oscclk", "mout_media_pll_div2"};
...
static const struct samsung_gate_clock mif_gate_clks[] __initconst = {
	GATE(0, "sclk_media_pll_top", "mout_media_pll_div2", EN_SCLK_TOP, 3, 0, 0),
...
PNAME(mout_bus_pll_top_user_p) = {"oscclk", "mout_bus_pll_top_user"};
...
PNAME(mout_aud_pll_top_user_p) = {"aud_pll", "mout_aud_pll_top_user"}; // USERMUX
PNAME(mux_bus_pll_top_user_p) = {"bus_pll", "mout_bus_pll_top_user"}; // USERMUX
PNAME(mout_media_pll_top_user_p) = {"sclk_media_pll_top", "mout_media_pll_top_user"}; // USERMUX
...
static const struct samsung_mux_clock top_mux_clks[] __initconst = {
	...
	MUX(0, "mout_aud_pll_top_user", mout_aud_pll_top_user_p, MUX_SEL_TOP1, 0, 1),
	MUX(CLK_MUX_BUS_PLL_TOP_USER, "mout_bus_pll_top_user", mux_bus_pll_top_user_p, MUX_SEL_TOP1, 4, 1),
	MUX(0, "mout_media_pll_top_user", mout_media_pll_top_user_p, MUX_SEL_TOP1, 8, 1),
};
...
static const struct samsung_div_clock top_div_clks[] __initconst = {
	...
	DIV(0, "dout_aclk_bus1_400", "mout_aclk_bus1_400", DIV_TOP0, 16, 4),
	DIV(0, "dout_aclk_bus0_400", "mout_aclk_bus0_400", DIV_TOP0, 12, 4),
	DIV(0, "dout_aclk_bus2_400", "mout_aclk_bus2_400", DIV_TOP0, 24, 4),
	DIV(0, "dout_aclk_peri_66", "mout_bus_pll_top_user", DIV_TOP0, 28, 4),
...
static const struct samsung_gate_clock top_gate_clks[] __initconst = {
	GATE(0, "aclk_fsys_200", "dout_aclk_fsys_200", EN_ACLK_TOP, 0, CLK_IGNORE_UNUSED, 0),
	GATE(0, "aclk_imem_266", "dout_aclk_imem_266", EN_ACLK_TOP, 1, CLK_IGNORE_UNUSED, 0),
	GATE(0, "aclk_imem_200", "dout_aclk_imem_200", EN_ACLK_TOP, 2, CLK_IGNORE_UNUSED, 0),
	GATE(CLK_ACLK_G3D_400, "aclk_g3d_400", "dout_aclk_g3d_400", EN_ACLK_TOP, 14, 0, 0),
	GATE(0, "aclk_isp_400", "dout_aclk_isp_400", EN_ACLK_TOP, 9, 0, 0),
	GATE(0, "aclk_isp_333", "dout_aclk_isp_333", EN_ACLK_TOP, 10, 0, 0),
	GATE(0, "aclk_isp_266", "dout_aclk_isp_266_top", EN_ACLK_TOP, 11, 0, 0),
	...
	GATE(0, "sclk_isp_spi0_ext_clk", "dout_sclk_isp_spi0_ext_clk_b", EN_SCLK_TOP_ISP, 0, 0, 0),
	GATE(0, "sclk_isp_spi1_ext_clk", "dout_sclk_isp_spi1_ext_clk_b", EN_SCLK_TOP_ISP, 1, 0, 0),
	GATE(0, "sclk_isp_uart_ext_clk", "dout_sclk_isp_uart_ext_uclk", EN_SCLK_TOP_ISP, 2, 0, 0),
	...
	GATE(0, "sclk_peri_i2s_i2scodclki", "dout_sclk_peri_i2s", EN_SCLK_TOP_PERI, 0, CLK_IGNORE_UNUSED, 0),
	...
	GATE(0, "sclk_peri_uart0_ext_uclk", "dout_sclk_peri_uart0", EN_SCLK_TOP_PERI, 7, 0, 0),
	GATE(0, "sclk_peri_uart1_ext_uclk", "dout_sclk_peri_uart1", EN_SCLK_TOP_PERI, 8, CLK_IGNORE_UNUSED, 0),
	GATE(0, "sclk_peri_uart2_ext_uclk", "dout_sclk_peri_uart2", EN_SCLK_TOP_PERI, 9, CLK_IGNORE_UNUSED, 0),
};
...
static const struct samsung_pll_clock top_pll_clks[] __initconst = {
	PLL(pll_2650x, CLK_AUD_PLL, "aud_pll", "oscclk", AUD_PLL_LOCK, AUD_PLL_CON0, table_aud),
};
...
PNAME(mout_sclk_i2s_i2scodclki_p) = {"ioclk_audiocdclk1", "oscclk",
...
static const struct samsung_gate_clock peri_gate_clks[] __initconst = {
	...
	GATE(0, "sclk_abb", "oscclk", EN_PCLK_PERIS, 0, CLK_IGNORE_UNUSED, 0),
	GATE(0, "sclk_tmu0", "oscclk", EN_PCLK_PERIS, 1, CLK_IGNORE_UNUSED, 0),
	GATE(0, "sclk_tmu1", "oscclk", EN_PCLK_PERIS, 2, CLK_IGNORE_UNUSED, 0),
	...
	GATE(0, "sclk_chipid", "oscclk", EN_PCLK_PERIS_SEC_CHIPID, 0, CLK_IGNORE_UNUSED, 0),
	GATE(0, "sclk_seckey", "oscclk", EN_PCLK_PERIS_SEC_SECKEY, 0, CLK_IGNORE_UNUSED, 0),
	...
	GATE(0, "sclk_antirbk_cnt", "oscclk", EN_PCLK_PERIS_SEC_ANTIRBK, 0, CLK_IGNORE_UNUSED, 0),
	...
	GATE(0, "sclk_pwm_tclk0", "oscclk", EN_SCLK_PERIC, 10, CLK_IGNORE_UNUSED, 0),
	GATE(0, "sclk_efuse_writer", "oscclk", EN_SCLK_PERIS, 3, CLK_IGNORE_UNUSED, 0),
	GATE(0, "sclk_custom_efuse", "oscclk", EN_SCLK_PERIS, 4, CLK_IGNORE_UNUSED, 0),
};
